...
export PATH="${PATH}:${JAVA_HOME}/bin:${CUDA_HOME}/bin:${JAVA_HOME}/jre/bin:${NETKIT_HOME}/bin:${ANDROID_SDK}/tools:${ANDROID_SDK}/platform-tools:${ANDROID_NDK}:${PGSQL_HOME}/bin:${ANT_HOME}/bin:/usr/local/heroku/bin"
